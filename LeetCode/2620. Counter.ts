...
counter() = 11 // Returns 1 more than the previous value each subsequent call.
counter() = 12 // Returns 1 more than the previous value each subsequent call.
Example 2:
